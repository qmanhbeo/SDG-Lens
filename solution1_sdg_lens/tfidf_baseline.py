...
def load_sdgi_parquet(data_dir: Path, language: str = "en", random_state: int = 42) -> tuple[pd.DataFrame, pd.DataFrame]:
...
def run_tfidf_baseline(
    ...
    train_df, test_df = load_sdgi_parquet(data_dir, language)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--data_dir", type=Path, default=HERE.parent / "SDGi" / "data")
