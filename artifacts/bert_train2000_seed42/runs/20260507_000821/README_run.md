...
```bash
python main.py eval --checkpoint /home/manh/study-BHam/AI4GC-2/artifacts/bert_train2000_seed42/runs/20260507_000821/model.pt
```

## Metrics

- micro-F1: 0.6854304635761589
- macro-F1: 0.6769744003055178
- weighted-F1: 0.6859047684777657
- subset accuracy: 0.6537369914853358
- average predicted labels: 1.4162724692526016
