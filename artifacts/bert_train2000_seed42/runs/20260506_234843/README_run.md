...
```bash
python main.py eval --checkpoint /home/manh/study-BHam/AI4GC-2/artifacts/bert_train2000_seed42/runs/20260506_234843/model.pt
```

## Metrics

- micro-F1: 0.6631016042780749
- macro-F1: 0.6458985314374587
- weighted-F1: 0.6623148770277002
- subset accuracy: 0.6433333333333333
- average predicted labels: 1.4866666666666666
