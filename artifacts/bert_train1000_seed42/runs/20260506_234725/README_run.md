...
```bash
python main.py eval --checkpoint /home/manh/study-BHam/AI4GC-2/artifacts/bert_train1000_seed42/runs/20260506_234725/model.pt
```

## Metrics

- micro-F1: 0.64
- macro-F1: 0.6269042499072636
- weighted-F1: 0.6377611410784015
- subset accuracy: 0.65
- average predicted labels: 1.2866666666666666
