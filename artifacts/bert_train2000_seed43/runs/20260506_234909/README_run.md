...
```bash
python main.py eval --checkpoint /home/manh/study-BHam/AI4GC-2/artifacts/bert_train2000_seed43/runs/20260506_234909/model.pt
```

## Metrics

- micro-F1: 0.663356504468719
- macro-F1: 0.6459455182608509
- weighted-F1: 0.6601106113339892
- subset accuracy: 0.6233333333333333
- average predicted labels: 1.7266666666666666
