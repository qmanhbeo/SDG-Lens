...
```bash
python main.py eval --checkpoint /home/manh/study-BHam/AI4GC-2/artifacts/bert_train2000_seed43/runs/20260507_000847/model.pt
```

## Metrics

- micro-F1: 0.6768947529917152
- macro-F1: 0.6754176602598099
- weighted-F1: 0.6772278311913682
- subset accuracy: 0.6130558183538316
- average predicted labels: 1.6423841059602649
