...
```bash
python main.py eval --checkpoint /home/manh/study-BHam/AI4GC-2/artifacts/bert_train2000_seed45/runs/20260506_234959/model.pt
```

## Metrics

- micro-F1: 0.6532343584305408
- macro-F1: 0.6323728540580593
- weighted-F1: 0.6496881095057463
- subset accuracy: 0.6466666666666666
- average predicted labels: 1.5133333333333334
