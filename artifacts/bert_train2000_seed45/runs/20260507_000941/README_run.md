...
```bash
python main.py eval --checkpoint /home/manh/study-BHam/AI4GC-2/artifacts/bert_train2000_seed45/runs/20260507_000941/model.pt
```

## Metrics

- micro-F1: 0.6778989098116948
- macro-F1: 0.6738746489482338
- weighted-F1: 0.6772277029776073
- subset accuracy: 0.6442762535477767
- average predicted labels: 1.422894985808893
