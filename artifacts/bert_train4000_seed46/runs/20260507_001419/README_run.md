...
```bash
python main.py eval --checkpoint /home/manh/study-BHam/AI4GC-2/artifacts/bert_train4000_seed46/runs/20260507_001419/model.pt
```

## Metrics

- micro-F1: 0.7182061579651942
- macro-F1: 0.7081260580117151
- weighted-F1: 0.7174765704854839
- subset accuracy: 0.6877956480605487
- average predicted labels: 1.3859981078524124
