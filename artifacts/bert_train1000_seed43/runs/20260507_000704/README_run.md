...
```bash
python main.py eval --checkpoint /home/manh/study-BHam/AI4GC-2/artifacts/bert_train1000_seed43/runs/20260507_000704/model.pt
```

## Metrics

- micro-F1: 0.6514633219308248
- macro-F1: 0.649835219738109
- weighted-F1: 0.6504722892127444
- subset accuracy: 0.6821192052980133
- average predicted labels: 1.0482497634815515
