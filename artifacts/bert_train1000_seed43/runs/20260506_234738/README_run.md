...
```bash
python main.py eval --checkpoint /home/manh/study-BHam/AI4GC-2/artifacts/bert_train1000_seed43/runs/20260506_234738/model.pt
```

## Metrics

- micro-F1: 0.6066584463625154
- macro-F1: 0.593890049594924
- weighted-F1: 0.6045578836286872
- subset accuracy: 0.6633333333333333
- average predicted labels: 1.0733333333333333
