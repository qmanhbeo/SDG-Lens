...
```bash
python main.py eval --checkpoint /home/manh/study-BHam/AI4GC-2/artifacts/bert_train2000_seed44/runs/20260507_000914/model.pt
```

## Metrics

- micro-F1: 0.7009063444108762
- macro-F1: 0.6944512713983861
- weighted-F1: 0.6996919042009643
- subset accuracy: 0.6584673604541155
- average predicted labels: 1.3774834437086092
